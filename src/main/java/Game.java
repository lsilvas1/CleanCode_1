...
public class Game {
    ...
    private void printResults(@org.jetbrains.annotations.NotNull ScoreBoard scoreBoard) {
    ...
    private void lose(@NotNull ScoreBoard scoreBoard) {
        System.out.println("you lose.");
        scoreBoard.incrementLosses();
    }

    private void tie(@NotNull ScoreBoard scoreBoard) {
        System.out.println("It's a tie");
        scoreBoard.incrementTie();
    }

    private void wins(@NotNull ScoreBoard scoreBoard) {
        System.out.println("you win!");
        scoreBoard.incrementWins();
    }

    private GameOption getChoiceNum(@NotNull String choice) {
